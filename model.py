...
class VGG(nn.Module):
    ...
    def __init__(self):
        ...
        self.features = nn.Sequential(
            nn.Conv2d(3,64,3,stride=(1,1),padding=(1,1)),
            nn.BatchNorm2d(64),
            ...
            nn.Conv2d(64,128,3,stride=(1,1),padding=(1,1)),
            nn.BatchNorm2d(128),
            nn.ReLU(inplace=True),
            nn.Conv2d(128,128,3,stride=(1,1),padding=(1,1)),
            nn.BatchNorm2d(128),
            nn.ReLU(inplace=True),
            nn.MaxPool2d(2,stride=2,padding=0,dilation=1,ceil_mode=False),
            nn.Conv2d(128,256,3,stride=(1,1),padding=(1,1)),
            nn.BatchNorm2d(256),
            nn.ReLU(inplace=True),
            nn.Conv2d(256,256,3,stride=(1,1),padding=(1,1)),
            nn.BatchNorm2d(256),
            nn.ReLU(inplace=True),
            nn.Conv2d(256,256,3,stride=(1,1),padding=(1,1)),
            nn.BatchNorm2d(256),
